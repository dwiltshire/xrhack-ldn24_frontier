...
import { HDREnvironment as HDREnvironment_12 } from "@zcomponent/three/lib/components/environments/HDREnvironment";
...
declare class Comp extends ZComponent {
	...
	nodes: {
		...
		PlaceholderSphere: Sphere_11 & {
			behaviors: {

			}
		},
		HDREnvironment: HDREnvironment_12 & {
			behaviors: {
